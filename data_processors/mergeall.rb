...
Merger.merge_file("Building Book - GSD - 4468 FY 2014_by_building_book_number.csv", 'APN', ['Street #', 'Street Dir', 'Street Name', 'Street Type', 'Zip Code'], true)
...
# Merger.merge_file("Recreation and Parks - Provided by Department.csv", 'APN', 'Address')
